...
plugins=(zsh-syntax-highlighting zsh-autosuggestions z)

source $ZSH/oh-my-zsh.sh

# User configuration

# Ctrl-Del to delete by word, pointless having it delete letter-by-letter
...
# Some distros call it fdfind due to name collision, use the real name
alias fd=fdfind
