...
you should place your code here."
  ...
  ;; Enable gtags keybindings for python
  (spacemacs/helm-gtags-define-keys-for-mode 'python-mode)
  ;; gtags keybindings overwrite the default anaconda ones, so set them to different keys
  (spacemacs/declare-prefix-for-mode 'python-mode "a" "anaconda")
